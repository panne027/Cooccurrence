...
public class DiscretizerMain {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			bfWrite.write("Iteration,Year,Month,Day,Latitude,Longitude,SCRoutppm,SCRoutgps,Bkpwr,pass");
			for(int i=0;i<dimensionsInfo.length;i++)
			{
			...
			{
				EngineReading r = allReadings.get(i);
				bfWrite.write(r.Iteration+","+r.year+","+r.month+","+r.day+","+r.Latitude+","+r.Longitude+","+r.SCRoutppm+","+r.SCRoutgps+","+r.Bkpwr+","+r.pass);
				for(int j=0;j<dimensionsInfo.length;j++)
